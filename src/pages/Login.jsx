...
export const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
          const response = await fetch("https://androidkey.alobhatech.com/api/auth/login", {
            method: "POST",
            headers: {
          ...
          if (response.ok) {
            ...
            // Assuming that res_data contains the user information or token
            storeTokenInLS(res_data.userEmail || res_data.token);
