...
export default function Admin() {
    ...
    // Handling the form submission for admin login
    const handleSubmit = async (e) => {
        e.preventDefault();

        // Check if entered credentials match the manual admin credentials
        if (user.email === manualAdmin.email && user.password === manualAdmin.password) {

            // Store the token in localStorage
            storeTokenInLS(manualAdmin.token);
    ...
    // Handling the navigation to user login
